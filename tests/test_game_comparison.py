...
def t_game(game_id, home='K-Laser Punainen', away='S-Kiekko Musta',
           time='13:30', location='Seinäjoki 2', date='Sat, 26 Sep 2026 00:00:00 GMT'):
    return {
        'Game ID': game_id,
        'Type': 'manage',
        'SortableDate': date,
...
def j_game(uid, home='K-Laser Punainen', away='S-Kiekko Musta',
           aika='13:30', paikka='Seinäjoki 2', pvm='2026-09-26'):
    return {
        'uid': uid,
...
def test_event_goes_to_best_scoring_game_not_the_first_one():
    ...
    """
    huono = t_game('huono', home='Sport Punainen', away='S-Kiekko Musta',
                   time='07:00', location='Vaasa hh 2',
                   date='Sat, 05 Sep 2026 00:00:00 GMT')
    hyva = t_game('hyva', home='S-Kiekko Punainen', away='Diskos Punainen',
                  time='13:30', location='Seinäjoki 2',
                  date='Sat, 05 Sep 2026 00:00:00 GMT')
    tapahtuma = j_game('229659', home='S-Kiekko Punainen', away='Diskos Punainen',
                       pvm='2026-09-05')
