        ...
        for team in all_teams:
            ...
            try:
                ...
                if not games_df.empty:
                    ...
                    games_df["Date"] = games_df["Date"].dt.strftime(
                        "%d.%m.%Y"
                    )  # Format for display
        ...
        for game in managed_games:
            try:
                ...
                if existing_game:
                    ...
                    if changes:
                        updated_games.append({"game_id": game["Game ID"], "changes": changes})

                    elif changes == {}:
                        updated_games.append({"game_id": game["Game ID"], "changes": "No changes"})
                    ...
                    if new_game:
                        added_games.append(
                            {"game date": new_game.date, "game id": new_game.game_id}
                        )
